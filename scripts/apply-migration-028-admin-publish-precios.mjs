...
const MIGRATION = '028_admin_publish_and_precios.sql';
...
async function main() {
  ...
  const { rows: fnRows } = await client.query(`
    ...
    WHERE routine_schema = 'public'
      AND routine_name IN ('get_precios_catalogo', 'admin_upsert_precios_batch', 'create_client_job')
  ...
  console.log('✅ Migration 028 (admin publish + precios) applied');
