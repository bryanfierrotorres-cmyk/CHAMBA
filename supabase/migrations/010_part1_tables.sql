-- CHAMBA 010 — Parte 1/4: tablas + índices + jobs.category → TEXT
-- Ejecuta SOLO este bloque en Supabase → SQL Editor → Run
-- Si vuelve a dar timeout, espera 1 min y ejecuta de nuevo (es idempotente).
...
-- jobs.category: enum → TEXT (puede tardar si hay muchos jobs)
DO $$
BEGIN
  IF EXISTS (
