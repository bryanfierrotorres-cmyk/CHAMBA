-- CHAMBA 028 — Precios admin (si faltaba 027) + publicar chambas sin límite de cliente para admin
SET statement_timeout = '120s';

-- ── precios_catalogo (idempotente) ──────────────────────────────────────────
...
-- ── create_client_job: admin no cuenta límite de 2 solicitudes activas ────────
