-- CHAMBA 045 — Agenda técnico con login teléfono (sin JWT obligatorio)
-- Alinea get_worker_assignments con get_worker_open_jobs_feed (017):
-- auth.uid() null → devuelve agenda si p_worker_id es técnico válido.
-- auth.uid() presente → solo propio worker o admin (038).
