-- CHAMBA 047 — Agenda técnico rápida (evita timeout PostgREST + login teléfono)
-- get_worker_agenda_panel: payload liviano, LIMIT 40, sin to_jsonb(j.*)
-- get_worker_assignments: misma lógica optimizada (compat)
